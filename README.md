...
pip install git+ssh://git@github.com/ToricLabs/datagrid-python.git
```
...
These methods return an [`APIResponse`](https://github.com/ToricLabs/datagrid-python/tree/main/src/datagrid_ai/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/ToricLabs/datagrid-python/tree/main/src/datagrid_ai/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/ToricLabs/datagrid-python/issues) with questions, bugs, or suggestions.
